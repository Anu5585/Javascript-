...
// console.log(this); // global contex this can be changed  thhis give us {} empty parenthises
...
// const userOne = new User("annass" , 12 ,true)
...
//     akPower : function (){
//         console.log(`Ak power is ${this.AK}`);

//     }
// }

// Object.prototype.Ak = function (){
//     console.log(`AK is present in all objects`);
// }
// myHeros.AK()
...
// const userr = new User ("Annas ", "Anas@anas.com", "123")
...
// const ak =new  Teacher("Anas", "Anas@anas.com","3322")

// ak.addCourse()

// const Khali  = new user("Khalid ")
// Khali.logMe()

// console.log(ak === Teacher);  //chking
...
//     static createId(){ //static  = us method ko ya us property kko access hony sy rok deta h
//         return `123`
//     }

// }

// const annas = new User ("Annas ")
// // console.log(annas.createId())
...
// const annas = new user("ak@ak.com", "abc")
// console.log(annas.password);
